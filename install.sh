...
_version="$(curl -s https://raw.githubusercontent.com/hug33k/eblih/v2.0.6/.version)"
curl -sL https://github.com/hug33k/eblih/archive/v$_version.tar.gz > /tmp/eblih.tar.gz
